...
export const ChartContainer = forwardRef((props: any, ref: any) => {
  const { container, layout, ...rest } = props;
...
export const Series = forwardRef((props: any, ref: any) => {
  const parent = useContext<any>(Context);
